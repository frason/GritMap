...
### Codex update — 2026-08-19 22:18 PDT

Karoo 0.8.0 adds the registered **GM Cardiac Drift** graphical field: a 45-second wait,
30-second rolling power/HR baseline, progress sparkline, and Stable/Drifting/High strain display
bands. Preview and live-demo data exercise it. The clean JVM suite passed (56 tests), focused
drift tests passed, and `assembleDebug` produced the APK. The work is uncommitted because the
Git approval request hit the current Codex usage limit; do not mix it with Claude's active root
app edits. Full details: `handoffs/archive/2026-08-19-2218-codex-karoo-cardiac-drift.md`.
